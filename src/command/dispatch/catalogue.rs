...
const EXEC_PROMPT: CommandSpec = CommandSpec {
    name: "prompt",
    aliases: &[],
    help: "Send a prompt to the agent in non-interactive mode.",
    long_help: None,
    arguments: &[ArgumentSpec {
        name: "prompt",
...
const NEW_WORKFLOW: CommandSpec = CommandSpec {
    ...
    flags: &[
        FlagSpec {
            long: "interview",
            short: None,
            help: "Let a code agent complete the workflow from a short summary.",
            kind: FlagKind::Bool,
            default: FlagDefault::Bool(false),
            frontends: FrontendVisibility::All,
            conflicts_with: &[],
...
const NEW_SKILL: CommandSpec = CommandSpec {
    ...
    flags: &[
        FlagSpec {
            long: "interview",
            short: None,
            help: "Let a code agent complete the skill body from a short summary.",
            kind: FlagKind::Bool,
            default: FlagDefault::Bool(false),
            frontends: FrontendVisibility::All,
            conflicts_with: &[],
